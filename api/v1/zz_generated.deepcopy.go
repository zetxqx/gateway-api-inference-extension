...
func (in *EndpointPickerPort) DeepCopyInto(out *EndpointPickerPort) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EndpointPickerPort.
func (in *EndpointPickerPort) DeepCopy() *EndpointPickerPort {
	if in == nil {
		return nil
	}
	out := new(EndpointPickerPort)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InferencePoolSpec) DeepCopyInto(out *InferencePoolSpec) {
	*out = *in
	...
	in.EndpointPickerRef.DeepCopyInto(&out.EndpointPickerRef)
}
