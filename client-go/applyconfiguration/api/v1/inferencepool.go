...
func (b *InferencePoolApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *InferencePoolApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InferencePoolApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *InferencePoolApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InferencePoolApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *InferencePoolApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
